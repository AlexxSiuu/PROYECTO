    ...
    <div class="carrito-container">
        ...
        <?php if (!$productos_carrito || count($productos_carrito) === 0): ?>
            <div class="carrito-vacio">
                ...
                <a href="https://jerseyking.kesug.com/proyecto.php">Continuar Comprando</a>
            </div>
        <?php else: ?>
        ...
        <div class="carrito-item" data-cart-id="<?= $item->id_carrito ?>">
            ...
            <div class="carrito-resumen">
                ...
                <div class="carrito-acciones">
                    <a href="https://jerseyking.kesug.com/proyecto.php" class="btn-accion btn-continuar">Continuar Comprando</a>
